...
# [PRIVATE/INTERNAL]
#
# create_arduino_target(TARGET_NAME ALL_SRCS ALL_LIBS INCLUDE_PATHS MANUAL)
#
...
#
#=============================================================================#
function(create_arduino_firmware_target TARGET_NAME BOARD_ID ALL_SRCS ALL_LIBS INCLUDE_PATHS MANUAL)

    string(STRIP "${ALL_SRCS}" ALL_SRCS)
    add_executable(${TARGET_NAME} "${ALL_SRCS}")
    set_target_properties(${TARGET_NAME} PROPERTIES SUFFIX ".elf")

    _set_board_compile_flags(${TARGET_NAME} ${BOARD_ID} "${INCLUDE_PATHS}" ${MANUAL})
    _set_board_link_flags(${TARGET_NAME} ${BOARD_ID} "${ALL_LIBS}" -lc -lm)
