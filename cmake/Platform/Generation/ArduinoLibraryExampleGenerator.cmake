...
function(GENERATE_ARDUINO_LIBRARY_EXAMPLE INPUT_NAME)
    ...
    find_arduino_libraries(LIB_NAMES TARGET_LIBS "" "${INPUT_LIBRARY}")
    ...
    make_arduino_libraries(ALL_LIBS ${BOARD_ID} "${TARGET_LIBS}" "${TARGET_LIBS}")

    list(APPEND ALL_LIBS ${CORE_LIB} ${INPUT_LIBS})

    create_arduino_firmware_target(${INPUT_NAME} ${BOARD_ID} "${ALL_SRCS}" "${ALL_LIBS}" "${TARGET_LIBS}"  FALSE)
